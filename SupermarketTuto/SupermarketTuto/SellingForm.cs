...
namespace SupermarketTuto
{
    public partial class SellingForm : Form
    {
        ...
        {
            Con.Open();
            string query = "select ProdName,ProdPrice from ProductTb1";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "insert into BillTb1 values (" + BillId.Text + ",'" + SellerNamelbl.Text + "','" + Datelbl.Text + "',"+Amtlbl.Text+")";
        ...
        {
            e.Graphics.DrawString("AMEL&EVESUPERMARKET", new Font("Century Gothic", 25, FontStyle.Bold), Brushes.Red, new Point(230));
            ...
            e.Graphics.DrawString("Amelia & Evelyn", new Font("Century Gothic", 20, FontStyle.Italic), Brushes.Red, new Point(270,230));
        }
